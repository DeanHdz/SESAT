...
const StudentAssignamentsList = ({ title, program }: { title: string, program: string }) => {
    ...
    return (
        <div className="w-full p-6 flex flex-col">
            ...
            <AdminAssignmentCard title="Registro" status={status}/>
            <AdminAssignmentCard title="Seminario de Tesis I (20% de avance)" status={status1}/>
            <AdminAssignmentCard title="Seminario de Tesis II (50% de avance)" status={status2}/>
            <AdminAssignmentCard title="Seminario de Tesis III (90% de avance)" status={status3}/>
            ...
            <AdminAssignmentCard title="Registro" status={status4}/>
            <AdminAssignmentCard title="Avance 1" status={status5}/>
            <AdminAssignmentCard title="Seminario de Tesis I (20% de la tesis)" status={status6}/>
            <AdminAssignmentCard title="Avance 3" status={status7}/>
            <AdminAssignmentCard title="Seminario de Tesis II (50% de la tesis)" status={status8}/>
            <AdminAssignmentCard title="Avance 5" status={status9}/>
            <AdminAssignmentCard title="Seminario de Tesis III (90% de la tesis)" status={status10}/>            
        </div>
    );
};
