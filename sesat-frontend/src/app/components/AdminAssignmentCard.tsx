...
const AdminAssignmentCard = ({
  ...
  const urlsArray1 = [
    '/admin-dashboard/assignments/masters/full-time/' + avance ,
    '/admin-dashboard/assignments/masters/full-time/' + avance ,
    '#'
  ];
  //Maestria medio tiempo
  const urlsArray2 = [
    '/admin-dashboard/assignments/masters/part-time/' + avance ,
    '/admin-dashboard/assignments/masters/part-time/' + avance ,
    '#'
  ];
  ...
  return (
    <div className="flex flex-row mt-3 p-2 bg-light-blue-10 rounded border border-light-gray-22 border-solid">
      ...
      <div className="flex w-[30px] lg:w-[50px] text-dark-blue-10 justify-center items-center">
        <svg stroke="currentColor" fill="none" strokeWidth="0" viewBox="0 0 24 24" height="30px" width="30px" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
      </div>
