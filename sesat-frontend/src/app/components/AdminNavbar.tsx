        ...
        <div className="lg:w-full flex justify-center items-center p-2 bg-light-blue-15 gray__border mb-6 h-[70px]">
            <div className="dropdown dropdown-bottom px-3 z-50 flex justify-start w-3/12">
                <label tabIndex={0} className="lg:hidden cursor-pointer hover:border-dark-blue-10">
                    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 20 20" height="24px" width="24px" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h6a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clipRule="evenodd"></path></svg>
                </label>
