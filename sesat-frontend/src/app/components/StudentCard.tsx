...
const StudentCard = () => {
    return (
        <Link href="view-thesis-masters/view-thesis" className="flex flex-row mb-1 p-2 bg-light-blue-10 rounded border border-light-gray-22 border-solid">
            ...
            <div className="ml-6 block w-auto">
                <p style={{ fontWeight: "bold" }}>Nombre del Alumno</p>                
                <p className="mt-1 text-sm">Fecha de entrega: dd/mm/yyyy</p>
            </div>            
        </Link>
    );
};
