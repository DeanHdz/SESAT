...
const StudentProfile = (props: InfoProps) => {
  return (
    <div className="w-full px-8 py-10 mt-4 mb-4 bg-light-blue-15 bg-opacity-50 gray__border !rounded-[15px] flex flex-col lg:flex-row">
      ...
      <div className="w-full ml-2 mr-2 flex-wrap">
        ...
        <div className="rounded-[15px] bg-white p-2 px-4 ml-2 mr-2">
