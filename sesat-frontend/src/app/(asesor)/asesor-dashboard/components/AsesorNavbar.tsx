...
export default async function AsesorNavbar() {
    ...
    <div className="lg:w-full flex justify-center items-center p-2 bg-light-blue-15 gray__border mb-6 h-[70px]">
        ...
        >
          <li>
            <div>
              ...
              <Link href="/asesor-dashboard"> Inicio </Link>
            </div>
          </li>
          <li>
            <div>
              ...
              <Link href="/asesor-dashboard/students/masters-degree"> Asesorados de maestría </Link>
            </div>
          </li>
          <li>
            <div>
              ...
              <Link href="/asesor-dashboard/sesat-users/alumnos/phd"> Asesorados de doctorado </Link>
            </div>
          </li>
        </ul>
      </div>
      ...
      <div className="w-3/12 px-3 flex flex-row justify-end items-center">
        <div className="w-fit px-3 flex flex-row items-center justify-center">
          <div className="w-[20px] h-[20px] mr-3 tooltip" data-tip={user && `${user.nombre} ${user.apellido_paterno} ${user.apellido_materno}`}>
