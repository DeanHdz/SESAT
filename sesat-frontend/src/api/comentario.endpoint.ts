...
export const getComentario = async (
  ...
  return await axios
    .get<SESAT.Comentario>(`${process.env.REACT_APP_API_HOSTNAME}/comentario/` + id, {
      headers: {
...
export const getAllComentarios = async (
  ...
  return await axios
    .get<SESAT.Comentario>(`${process.env.REACT_APP_API_HOSTNAME}/comentario`, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `bearer ${token}`,
      },
...
export const postComentario = async (
  ...
  return await axios
    .post(`${process.env.REACT_APP_API_HOSTNAME}/usuario`, CreateComentarioDto, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `bearer ${token}`,
      },
...
export const putComentario = async (
  ...
  return await axios
    .put(`${process.env.REACT_APP_API_HOSTNAME}/usuario`, UpdateComentarioDto, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `bearer ${token}`,
      },
